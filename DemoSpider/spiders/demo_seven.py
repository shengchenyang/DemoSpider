...
class DemoSevenSpider(AyuSpider):
    ...
    def start_requests(self):
        ...
        yield Request(
            ...
            meta={"meta_data": "这是用来测试 parse_get_fir meta 的功能"},
            dont_filter=True,
        )
        ...
        yield Request(
            ...
            meta={"meta_data": "这是用来测试 parse_get_sec meta 的功能"},
            dont_filter=True,
        )
        ...
        yield Request(
            ...
            meta={"meta_data": "这是用来测试 parse_post_fir meta 的功能"},
            dont_filter=True,
        )
        ...
        yield FormRequest(
            ...
            meta={"meta_data": "这是用来测试 parse_post_sec meta 的功能"},
            dont_filter=True,
        )
